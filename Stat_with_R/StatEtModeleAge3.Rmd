...
ModelnucBy10Mic3 <- lmer(nucBy10Mic3.t~Date*Strain2+(1|ID2), data = DATA_AGE)

summary(ModelnucBy10Mic3)

ModelnucBy10Mic3_2 <- lmer(nucBy10Mic3.t~Date+Strain2+(1|ID2), data = DATA_AGE)
...
tab_model(ModelnucBy10Mic3_2, 
			 ...
			 pred.labels = c("Intersection", "Age", "Lu vs LuVieux", "Lu vs Malu"))
```
...
```{r }
aggregate(nucBy10Mic3 ~ Date + Strain2, data = DATA_AGE, FUN = mean)
aggregate(nucBy10Mic3 ~ Date + Strain2, data = DATA_AGE, FUN = sd)
aggregate(nucBy10Mic3 ~ Strain2, data = DATA_AGE, FUN = mean)
aggregate(nucBy10Mic3 ~ Strain2, data = DATA_AGE, FUN = sd)
```
...
GraphnucBy10Mic3 <-
	...
	scale_x_discrete(breaks = c("LuJeune", "LuVieux", "MaLu"),
						  labels = c("LuJ", "LuV", "Malu")) +
	stat_summary(
		fun = mean,
		geom = "point",
		shape = 20,
...
Date.labs <- c("june 2021", "june 2022")

names(Date.labs) <- c("21", "22")
...
```{r ,echo=CODE, result=CODE,message=FALSE}
ModelmeanAreaNuc <- 
	lmer(meanAreaNuc.t ~ Date * Strain2 + (1 |ID2), data = DATA_AGE)
...
```{r }
aggregate(meanAreaNuc ~ Date + Strain2, data = DATA_AGE, FUN = mean)
aggregate(meanAreaNuc ~ Date + Strain2, data = DATA_AGE, FUN = sd)
aggregate(meanAreaNuc ~ Strain2, data = DATA_AGE, FUN = mean)
aggregate(meanAreaNuc ~ Strain2, data = DATA_AGE, FUN = sd)
```
...
```{r ,echo=CODE, result=CODE,message=FALSE}
ModelAR <- lmer(AR.t ~ Date * Strain2 + (1 | ID2), data = DATA_AGE)

summary(ModelAR)

ModelAR_2 <- lmer(AR.t ~ Date + Strain2 + (1 | ID2), data = DATA_AGE)
...
```{r }
aggregate(AR ~ Date + Strain2, data = DATA_AGE, FUN = mean)
aggregate(AR ~ Date + Strain2, data = DATA_AGE, FUN = sd)
aggregate(AR ~ Strain2, data = DATA_AGE, FUN = mean)
aggregate(AR ~ Strain2, data = DATA_AGE, FUN = sd)
```
...
```{r ,echo=CODE, result=CODE,message=FALSE}
ModelmitoBy10Mic3 <- lmer(mitoBy10Mic3.t ~ Date * Strain2 +(1 | ID2), data = DATA_AGE)

summary(ModelmitoBy10Mic3)

ModelmitoBy10Mic3_2 <- lmer(mitoBy10Mic3.t ~ Date +Strain2 +(1 | ID2), data = DATA_AGE)
...
```{r }
aggregate(mitoBy10Mic3 ~ Date + Strain2, data = DATA_AGE, FUN = mean)
aggregate(mitoBy10Mic3 ~ Date + Strain2, data = DATA_AGE, FUN = sd)
aggregate(mitoBy10Mic3 ~ Strain2, data = DATA_AGE, FUN = mean)
aggregate(mitoBy10Mic3 ~ Strain2, data = DATA_AGE, FUN = sd)
```
...
```{r ,echo=CODE, result=CODE,message=FALSE}
ModelIntBy10Mic3 <- lmer(IntBy10Mic3.t ~ Date * Strain2 + (1 | ID2), data = DATA_AGE)

summary(ModelIntBy10Mic3)

ModelIntBy10Mic3_2 <- lmer(IntBy10Mic3.t ~ Date + Strain2 + (1 | ID2), data = DATA_AGE)
...
```{r }
aggregate(IntBy10Mic3 ~ Date + Strain2, data = DATA_AGE, FUN = mean)
aggregate(IntBy10Mic3 ~ Date + Strain2, data = DATA_AGE, FUN = sd)
aggregate(IntBy10Mic3 ~ Strain2, data = DATA_AGE, FUN = mean)
aggregate(IntBy10Mic3 ~ Strain2, data = DATA_AGE, FUN = sd)
```
