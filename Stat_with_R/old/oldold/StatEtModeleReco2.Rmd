...
ModelnucBy10Mic3 <-
  lmer(nucBy10Mic3.t ~ Awake * Strain + (1 | ID2), data = DATA_RECOVERY)
...
```{r }
aggregate(nucBy10Mic3 ~ Awake + Strain, data = DATA_RECOVERY, FUN = mean)
aggregate(nucBy10Mic3 ~ Awake + Strain, data = DATA_RECOVERY, FUN = sd)
aggregate(nucBy10Mic3 ~ Strain, data = DATA_RECOVERY, FUN = mean)
aggregate(nucBy10Mic3 ~ Strain, data = DATA_RECOVERY, FUN = sd)
```
...
```{r ,echo=CODE, result=CODE,message=FALSE}
ModelmeanAreaNuc <-
  lmer(meanAreaNuc.t ~ Awake * Strain + (1 | ID2), data = DATA_RECOVERY)
...
```{r }
aggregate(meanAreaNuc ~ Awake + Strain, data = DATA_RECOVERY, FUN = mean)
aggregate(meanAreaNuc ~ Awake + Strain, data = DATA_RECOVERY, FUN = sd)
aggregate(meanAreaNuc ~ Strain, data = DATA_RECOVERY, FUN = mean)
aggregate(meanAreaNuc ~ Strain, data = DATA_RECOVERY, FUN = sd)
```
...
```{r ,echo=CODE, result=CODE,message=FALSE}
ModelAR <- lmer(AR.t ~ Awake * Strain + (1 | ID2), data = DATA_RECOVERY)

summary(ModelAR)

ModelAR_2 <- lmer(AR.t ~ Awake + Strain + (1 | ID2), data = DATA_RECOVERY)
...
```{r }
aggregate(AR ~ Awake + Strain, data = DATA_RECOVERY, FUN = mean)
aggregate(AR ~ Awake + Strain, data = DATA_RECOVERY, FUN = sd)
aggregate(AR ~ Strain, data = DATA_RECOVERY, FUN = mean)
aggregate(AR ~ Strain, data = DATA_RECOVERY, FUN = sd)
```
...
```{r ,echo=CODE, result=CODE,message=FALSE}
ModelmitoBy10Mic3 <- lmer(mitoBy10Mic3.t ~ Awake * Strain + (1 | ID2), data = DATA_RECOVERY)

summary(ModelmitoBy10Mic3)

ModelmitoBy10Mic3_2 <- lmer(mitoBy10Mic3.t ~ Awake + Strain + (1 | ID2), data = DATA_RECOVERY)
...
```{r }
aggregate(mitoBy10Mic3 ~ Awake + Strain, data = DATA_RECOVERY, FUN = mean)
aggregate(mitoBy10Mic3 ~ Awake + Strain, data = DATA_RECOVERY, FUN = sd)
aggregate(mitoBy10Mic3 ~ Strain, data = DATA_RECOVERY, FUN = mean)
aggregate(mitoBy10Mic3 ~ Strain, data = DATA_RECOVERY, FUN = sd)
```
...
```{r ,echo=CODE, result=CODE,message=FALSE}
ModelIntBy10Mic3 <-
  lmer(IntBy10Mic3.t ~ Awake * Strain + (1 | ID2), 
       data = DATA_RECOVERY)
...
```{r }
aggregate(IntBy10Mic3 ~ Awake + Strain, data = DATA_RECOVERY, FUN = mean)
aggregate(IntBy10Mic3 ~ Awake + Strain, data = DATA_RECOVERY, FUN = sd)
aggregate(IntBy10Mic3 ~ Strain, data = DATA_RECOVERY, FUN = mean)
aggregate(IntBy10Mic3 ~ Strain, data = DATA_RECOVERY, FUN = sd)
```
