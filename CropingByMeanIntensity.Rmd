...
ggplot(Luj_21, aes(x = slice, y = name, height = values, fill=name) ) + geom_ridgeline(scale=0.03, alpha = 0.5, show.legend = FALSE)
ggplot(Luv_21, aes(x = slice, y = name, height = values, fill=name) ) + geom_ridgeline(scale=0.03, alpha = 0.5, show.legend = FALSE)
ggplot(Malu_21, aes(x = slice, y = name, height = values, fill=name) ) + geom_ridgeline(scale=0.03, alpha = 0.5, show.legend = FALSE)
ggplot(Luj_22, aes(x = slice, y = name, height = values, fill=name) ) + geom_ridgeline(scale=0.03, alpha = 0.5, show.legend = FALSE)
ggplot(Luv_22, aes(x = slice, y = name, height = values, fill=name) ) + geom_ridgeline(scale=0.03, alpha = 0.5, show.legend = FALSE)
ggplot(Malu_22, aes(x = slice, y = name, height = values, fill=name) ) + geom_ridgeline(scale=0.03, alpha = 0.5, show.legend = FALSE)
ggplot(Luj_22R, aes(x = slice, y = name, height = values, fill=name) ) + geom_ridgeline(scale=0.03, alpha = 0.5, show.legend = FALSE)
ggplot(Luv_22R, aes(x = slice, y = name, height = values, fill=name) ) + geom_ridgeline(scale=0.03, alpha = 0.5, show.legend = FALSE)
ggplot(Malu_22R, aes(x = slice, y = name, height = values, fill=name) ) + geom_ridgeline(scale=0.03, alpha = 0.5, show.legend = FALSE)
